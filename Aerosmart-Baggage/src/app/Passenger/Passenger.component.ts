...
export class PassengerComponent implements OnInit {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.aerosmart.baggageTracker.Passenger',
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.servicePassenger.updateParticipant(form.get('passengerId').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.luggages) {
        formObject.luggages = result.luggages;
      } else {
        formObject.luggages = null;
      }
